	...
	public function execute(array $deferred, array $data, $targetRunTime, &$status)
	{
		...
		if (!empty($apiKey))
		{
			try
			{
				...
				$existingDevices = XenForo_Model::create('bdPhotos_Model_Device')->getDevices(array('manufacture' => $flickrManufactures), array('join' => bdPhotos_Model_Device::FETCH_CODE));
