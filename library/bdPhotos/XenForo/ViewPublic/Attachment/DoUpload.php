        ...
        if (!empty($this->_params['content_type']) AND $this->_params['content_type'] == 'bdphotos_album') {
            ...
            if (is_readable($filePath)) {
                ...
                if (!empty($attachment['metadataArray']['lat']) AND !empty($attachment['metadataArray']['lng'])) {
                    ...
                    $locationModel = $attachmentModel->getModelFromCache('bdPhotos_Model_Location');
                    $location = $locationModel->getLocationNear($attachment['metadataArray']['lat'], $attachment['metadataArray']['lng']);
                    if (!empty($location)) {
