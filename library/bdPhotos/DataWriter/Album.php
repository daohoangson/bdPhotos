...
class bdPhotos_DataWriter_Album extends XenForo_DataWriter
{
    ...
    protected function _savePhotos($photoInput)
    {
        ...
        foreach ($photos as $photo) {
            ...
            /** @var bdPhotos_DataWriter_Photo $photoDw */
    ...
    protected function _deleteAttachments()
    {
        /** @var XenForo_Model_Attachment $attachmentModel */
        $attachmentModel = $this->getModelFromCache('XenForo_Model_Attachment');
        $attachmentModel->deleteAttachmentsFromContentIds('bdphotos_album', array($this->get('album_id')));
    }
    ...
    protected function _deletePhotos()
    {
        ...
        if (!empty($photoIds)) {
            ...
            $likeModel->deleteContentLikes('bdphotos_photo', $photoIds, true);
            ...
            $alertModel->deleteAlerts('bdphotos_photo', $photoIds);
        }
    }
    ...
    protected function _deleteLikes()
    {
        /** @var XenForo_Model_Like $likeModel */
        $likeModel = $this->getModelFromCache('XenForo_Model_Like');
        $likeModel->deleteContentLikes('bdphotos_album', $this->get('album_id'), true);
    }
    ...
    protected function _deleteAlerts()
    {
        /** @var XenForo_Model_Alert $alertModel */
        $alertModel = $this->getModelFromCache('XenForo_Model_Alert');
        $alertModel->deleteAlerts('bdphotos_album', $this->get('album_id'));
    }
