	...
	protected $_dataClasses = array(
		'photo' => array(
			...
			'fields' => array(
				...
				'photo_score' => array('name' => 'photo_score', 'type' => 'uint', 'required' => true, 'default' => 0),
				'score_date' => array('name' => 'score_date', 'type' => 'uint', 'required' => true, 'default' => 0),
			...
			'indeces' => array(
				...
				'photo_score' => array('name' => 'photo_score', 'fields' => array('photo_score'), 'type' => 'NORMAL'),
			),
			'files' => array(
				'data_writer' => array('className' => 'bdPhotos_DataWriter_Photo', 'hash' => 'e844a9557266f4c648cfbff685e1c9f4'),
				'model' => array('className' => 'bdPhotos_Model_Photo', 'hash' => '3115be043ab644c7a1c6720ce537a287'),
		...
		'scoring' => array(
			'name' => 'scoring',
			'camelCase' => 'Scoring',
			'camelCasePlural' => 'Scorings',
			'camelCaseWSpace' => 'Scoring',
			'camelCasePluralWSpace' => 'Scorings',
			'fields' => array(
				'photo_id' => array('name' => 'photo_id', 'type' => 'uint', 'required' => true),
				'action' => array('name' => 'action', 'type' => 'string', 'length' => 25, 'required' => true),
				'user_id' => array('name' => 'user_id', 'type' => 'uint', 'required' => true),
			...
			'primaryKey' => array('photo_id'),
			'indeces' => array(
				'date' => array('name' => 'date', 'fields' => array('date'), 'type' => 'NORMAL'),
			),
